...
export default class Toaster extends React.Component<IToasterProps, IToasterState> {
    ...
    render(): React.ReactNode {
        ...
        return (
            <div
                className={`toasts-container${countModal > 0 ? '-modal' : ''}`}
            ...
            >
                ...
                <div className='toast-container-center'>
                    {this.props.placesCount < countToShow ? (
                        <span className='toast-container-count-label'>
            ...
            <div className={`toast-container-${this.props.type}`}>
                ...
                {this.props.description !== undefined ? (
                    <span
                        ...
                        className={`toast-description-button${this.state.showDescription ? '-selected' : ''}`}
                    >
                        <span>∴</span>
                    </span>
                ) : (
